...
//        printf("authcode:%s, rauthcode:%s\n",authcode,rauthcode);
//        printf("s->filestream:%p\n",s->filestream);
        ...
        //compare authcode and rauthcode,the N is 10
//        printf("\nauthcode:%s\n",authcode);
//        printf("\nrauthcode:%s\n",rauthcode);
//        printf("memcmp result is %d\n",memcmp(authcode, rauthcode, AES_AUTHCODESIZE));
//        if (memcmp(authcode, rauthcode, AES_AUTHCODESIZE) < 0) {
//            printf("authcode less than rauthcode...\n");
//        }else if (memcmp(authcode, rauthcode, AES_AUTHCODESIZE) > 0){
//            printf("authcode granter than rauthcode...\n");
//        }
        

        /*
         #FIXME: CRC ERROR IF FILE CONTENT IS EMPTY,WHEN THE ZIP USE THE PASSWD
         if (memcmp(authcode, rauthcode, AES_AUTHCODESIZE) != 0)
            err = UNZ_CRCERROR;
         */
    }
