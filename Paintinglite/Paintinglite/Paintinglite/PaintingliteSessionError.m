...
+ (instancetype)sharePaintingliteSessionError{
    ...
    dispatch_once(&onceToken, ^{
        NSDictionary *userInfo = @{NSLocalizedDescriptionKey:@"传入文件名称有误，无法打开数据库",NSLocalizedFailureReasonErrorKey:@"失败原因:文件打开失败",NSLocalizedRecoverySuggestionErrorKey:@"恢复建议:重新设置文件名称"};
